  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="space-y-8">
          ...
          <div>
            <label className="inline-block">
              <input
                ...
                className="hidden"
              />
              <span className="flex items-center gap-3 px-6 py-3 bg-white hover:bg-slate-50 border-2 border-slate-200 rounded-xl cursor-pointer transition-colors font-medium text-sm text-slate-700">
                {isUploading ? (
                  <>
        ...
        {/* Actions */}
        <div className="pt-8 border-t-2 border-slate-200 flex items-center gap-4">
          <button
            onClick={handleSave}
