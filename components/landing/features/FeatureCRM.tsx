            ...
            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 max-w-md mx-auto relative hover:border-slate-300 transition-all">
              ...
              <div className="flex items-center justify-between mb-8 pb-6 border-b-2 border-slate-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Customer Profile</h3>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1.5 rounded-full bg-[#005bbc]/10 text-[#005bbc] text-xs font-semibold border-2 border-[#005bbc]/20">VIP</span>
                <span className="px-3 py-1.5 rounded-full bg-[#ffd600]/10 text-[#005bbc] text-xs font-semibold border-2 border-[#ffd600]/20">Active Deal</span>
                <span className="px-3 py-1.5 rounded-full bg-slate-50 text-slate-600 text-xs font-semibold border-2 border-slate-200">Enterprise</span>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-3 p-3 rounded-xl bg-slate-50 border-2 border-slate-200 hover:border-slate-300 transition-all">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-slate-900">Demo Call Scheduled</p>
